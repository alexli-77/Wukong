...
public class CandidateTrigger  extends AbstractProcessor<CtMethod<?>> {
    private static final Logger LOGGER = CustomLogger.log(CandidateTrigger.class.getName());
    ...
    public boolean isToBeProcessed(CtMethod<?> candidate) {
        return candidate.getAllMetadata().containsKey("wukong-tag");
    }
